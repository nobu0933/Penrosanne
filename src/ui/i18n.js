...
const messages = {
	ja: {
		...
		'hand.choose': '置くタイルを選択', 'hand.number': '手札{number}', 'hand.tile': '{player}の手札{number}', 'hand.redrawNeeded': '手札を1枚引き直してください', 'hand.collapse': 'タイル選択を畳む', 'hand.reopen': 'タイル選択を開く', 'log.pass': 'パス',
		...
		'deck.game': 'GAME DECK', 'deck.select': '山札', 'deck.matchingPattern': 'マッチングの反転', 'deck.terrainPattern': '地形回転', 'deck.terrainMirror': '地形反転',
		...
		'board.title': 'ひし形の谷', 'board.confirmed': '確定配置', 'board.candidate': 'このタイルを配置可能', 'board.canvas': 'ゲーム盤面', 'board.rotate': '180度回転', 'board.rotateTerrain': '地形を180度回転', 'board.mirrorTerrain': '地形を左右反転', 'board.cyclePlacement': '設置方向を切り替え（{number}/{total}）', 'board.confirm': '配置を確定', 'board.skipMeeple': 'ミープルを置かない', 'board.help': 'ドラッグで移動　／　ホイール・ピンチで拡大縮小　／　候補をクリックして配置', 'board.forceEnd': 'デバッグ：強制終了・採点', 'board.forceEndTitle': 'デバッグ用：ただちに終局得点を計算します',
		...
		'deck.lite': 'Lite', 'deck.standard': 'Standard', 'deck.expansion': '拡張版', 'deck.roadOnly': '道だけ', 'deck.liteDescription': '{count}枚・短時間向け', 'deck.standardDescription': '{count}枚・暫定基本セット', 'deck.expansionDescription': '{count}枚・長時間向け', 'deck.roadOnlyDescription': '{count}枚・道／交差点／修道院のみ',
	},
	en: {
		...
		'hand.choose': 'Choose a tile', 'hand.number': 'Tile {number}', 'hand.tile': '{player}, tile {number}', 'hand.redrawNeeded': 'Redraw one tile from your hand', 'hand.collapse': 'Collapse tile choice', 'hand.reopen': 'Open tile choice', 'log.pass': 'passed',
		...
		'setup.playerCount': 'Players', 'setup.players2': '2 players', 'setup.players3': '3 players', 'setup.players4': '4 players', 'setup.playerName': 'Player name', 'setup.defaultPlayerName': 'Player{number}', 'setup.player1Color': 'Player 1 meeple color', 'setup.player2Color': 'Player 2 meeple color', 'setup.player3Color': 'Player 3 meeple color', 'setup.player4Color': 'Player 4 meeple color', 'setup.colorNumber': 'Color {number}', 'setup.duplicateColorsTitle': 'Meeple colors overlap', 'setup.duplicateColorsMessage': 'Two or more players have selected the same color. Start or resume the game anyway?',
		...
		'deck.game': 'GAME DECK', 'deck.select': 'Deck', 'deck.matchingPattern': 'Matching reversal', 'deck.terrainPattern': 'Terrain rotation', 'deck.terrainMirror': 'Terrain mirror', 'deck.both': 'Allow normal and 180° rotation', 'deck.normalOnly': 'Normal only', 'deck.unlimited': 'Check and use unlimited times', 'deck.mirrorDisabled': 'Unavailable', 'deck.start': 'Start a new game with this deck',
		...
		'board.title': 'Rhombus Valley', 'board.confirmed': 'Forced placement', 'board.candidate': 'Place current tile here', 'board.canvas': 'Game board', 'board.rotate': 'Rotate 180°', 'board.rotateTerrain': 'Rotate terrain 180°', 'board.mirrorTerrain': 'Mirror terrain', 'board.cyclePlacement': 'Change placement pattern ({number}/{total})', 'board.confirm': 'Confirm placement', 'board.skipMeeple': 'Skip meeple', 'board.help': 'Drag to pan / wheel or pinch to zoom / click a candidate to preview', 'board.forceEnd': 'Debug: end game & score', 'board.forceEndTitle': 'Debug: calculate final scores immediately',
		...
		'deck.lite': 'Lite', 'deck.standard': 'Standard', 'deck.expansion': 'Expansion', 'deck.roadOnly': 'Road only', 'deck.liteDescription': '{count} tiles · quick game', 'deck.standardDescription': '{count} tiles · provisional base set', 'deck.expansionDescription': '{count} tiles · longer game', 'deck.roadOnlyDescription': '{count} tiles · roads, junctions, and monasteries only',
	},
};

let currentLanguage = localStorage.getItem(STORAGE_KEY) === 'ja' ? 'ja' : 'en';
...
export function deckText(deck) {
	const key = { lite: 'lite', standard: 'standard', expansion: 'expansion', 'road-only': 'roadOnly' }[deck.id] || deck.id;
	return { label: t(`deck.${key}`), description: t(`deck.${key}Description`, { count: deck.count }) };
}
